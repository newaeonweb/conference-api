...
// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('speakers');'use strict';
// Use Applicaion configuration module to register a new module
...
//Setting up route
angular.module('speakers').config([
  '$stateProvider',
  function ($stateProvider) {
    // Speakers state routing
    $stateProvider.state('listSpeakers', {
      url: '/speakers',
...
angular.module('speakers').controller('SpeakersController', [
  ...
  function ($scope, $stateParams, $location, Authentication, Speakers) {
    ...
    $scope.findOne = function () {
      $scope.speaker = Speakers.get({ speakerId: $stateParams.speakerId });
    };
  }
]);'use strict';
//Speakers service used to communicate Speakers REST endpoints
angular.module('speakers').factory('Speakers', [
  '$resource',
  function ($resource) {
    return $resource('speakers/:speakerId', { speakerId: '@_id' }, { update: { method: 'PUT' } });
  }
]);'use strict';
